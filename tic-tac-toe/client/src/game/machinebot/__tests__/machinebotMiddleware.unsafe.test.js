...
describe('Machine bot middleware unsafe utils', () => {
    ...
    it('returns a valid move when allowed (100 tries)', () => {
        const VALUES = [SIGN_NONE, SIGN_O, SIGN_X, SIGN_NONE, SIGN_O, SIGN_X, SIGN_NONE, SIGN_O, SIGN_X].map(val);
    ...
    it('returns a invalid move when no more moves available', () => {
        const VALUES = [SIGN_X, SIGN_O, SIGN_X, SIGN_O, SIGN_O, SIGN_X, SIGN_X, SIGN_O, SIGN_X].map(val);
